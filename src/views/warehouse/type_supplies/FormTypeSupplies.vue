<template>
  <div class="content-page">
    <section>
      <top-bar :page-title="post?'Nuevo Tipo de Insumo':'Editar Tipo de Insumo'"/>
...
export default {
  ...
  methods: {
    ...
    ...mapActions({
      ...
      saveTypeSupplies: 'SAVE_TYPE_SUPPLIES',
      editTypeSupplies: 'EDIT_TYPE_SUPPLIES'
    }),
    update_values() {
    ...
    save() {
      ...
      if (this.post)
        this.saveTypeSupplies(this.type_supplies_object);
      else
        this.editTypeSupplies(this.type_supplies_object)
    },
  },
